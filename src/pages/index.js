      ...
      <div>
        ...
        >
          <div className="md:ml-8 md:mt-3 lg:ml-12">
            ...
            <div className="text-base mt-1 md:text-base text-gray-100">
              By Hollie-Ella
            </div>
            <ul className="md:flex mt-6 hidden text-gray-100">
              <li className="mr-8">
                <a href="https://www.facebook.com/inthecountrymagazine/">
                  <svg
                    width="24"
                    height="24"
                    fill="#d7b9a1"
              ...
              <li className="mr-8">
                <a href="https://twitter.com/inthe_country?lang=en-gb">
                  <svg
                    width="24"
                    height="24"
                    fill="#d7b9a1"
              ...
              <li className="mr-8">
                <a href="https://www.instagram.com/inthecountryinsta/">
                  <svg
                    width="24"
                    height="24"
                    fill="#d7b9a1"
        ...
        <div className="text-center p-8 max-w-md md:max-w-lg m-auto mt-16 lg:max-w-xl lgx:max-w-2xl lgx:mt-24">
          ...
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl">
            Introducing the very first In The Country podcast. In this debut
            episode, meet your host, Hollie-Ella and find out about how and why
            she decided to take the bold leap and launch In The Country Magazine
            at just aged 21!
          </div>
          {/* <div className="mt-3 text-gray-700 leading-relaxed md:text-xl">
          ...
          <div className="mt-6 mb-6 text-gray-700 leading-relaxed md:text-xl">
            Subscribe to our newsletter to stay upto data on all things In The
            Country
          </div>
        ...
        <div className="w-full bg-gray-100 text-center pb-8 md:pb-16 mt-16 lgx:mt-24">
          <div className="max-w-lg md:max-w-xl m-auto lgx:max-w-2xl">
            ...
            <div className="font-medium text-gray-700 leading-relaxed pl-8 pr-8 mt-6 md:mt-12 md:text-xl">
              ...
              and bonuses for the price of a cup of coffee a month!
            </div>
